      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20 border-t border-gray-800">
          ...
          <div
            ...
            data-aos="fade-right"
          >
            <div className="w-1/2">{<Image src={robing} alt="person3d" />}</div>
            <div className="w-1/2">
              <h1 className="text-center text-2xl">Past Live</h1>{" "}
              <p className="ml-1">
                "In the past, there was an incredible story in which a special
                bond, standing on wet ground despite the absence of rain, came
                to an end, opening a new beginning. This moment proved to be a
                significant step for this story, and it moved on to the next
